{
  ...
  table_manager_args::
    $._config.storageConfig
    {
      ...
      'table-manager.chunk-table.inactive-read-throughput': 0,
      'table-manager.chunk-table.inactive-write-throughput': 0,
      'table-manager.chunk-table.read-throughput': 0,
      'table-manager.chunk-table.write-throughput': 0,
      'table-manager.index-table.inactive-read-throughput': 0,
      'table-manager.index-table.inactive-write-throughput': 0,
      'table-manager.index-table.read-throughput': 0,
      'table-manager.index-table.write-throughput': 0,
